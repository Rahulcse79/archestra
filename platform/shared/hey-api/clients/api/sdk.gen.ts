 ...
 */
export const deleteInternalMcpCatalogItemLocalConfigSecret = <ThrowOnError extends boolean = false>(options: Options<DeleteInternalMcpCatalogItemLocalConfigSecretData, ThrowOnError>) => (options.client ?? client).delete<DeleteInternalMcpCatalogItemLocalConfigSecretResponses, DeleteInternalMcpCatalogItemLocalConfigSecretErrors, ThrowOnError>({ url: '/api/internal_mcp_catalog/{id}/local-config-secret', ...options });
